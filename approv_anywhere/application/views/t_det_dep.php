        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <center><h6>Detail Approv Deposito Baru </h6></center>
            </div>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm"><?php echo $d['NO_REKENING'];?></h6>
                          </div>
                        </div>
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">JENIS DEPOSITO</h6>
                          </div>
                        </div>
                      </td>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm"><?php echo $d['DESKRIPSI_JENIS_DEPOSITO'];?></h6>
                          </div>
                        </div>
                      </td>
                    </tr>
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">TANGGAL REGISTRASI | TANGGAL JATUH TEMPO  </h6>
                          </div>
                        </div>
                      </td>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm"><?php echo $d['TGL_REGISTRASI']." | ".$d['TGL_JT'];?></h6>
                          </div>
                        </div>
                      </td>
                    </tr>
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">SUKU BUNGA | JUMLAH DEPOSITO  </h6>
                          </div>
                        </div>
                      </td>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm"><?php echo $d['SUKU_BUNGA']." | Rp.".number_format($d['JML_DEPOSITO'],0,",",".");?></h6>
                          </div>
                        </div>
                      </td>
                    </tr>
